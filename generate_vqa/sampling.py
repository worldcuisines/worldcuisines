...
if __name__ == '__main__':
    ...
    parser.add_argument('-np1a', '--n-prompt-max-type1a', type=int, required=False, default=-1, help="Maximum different number of prompt type 1 to be sampled (-1 means can sample as many as possible).")
    parser.add_argument('-np1b', '--n-prompt-max-type1b', type=int, required=False, default=-1, help="Maximum different number of prompt type 2 to be sampled (-1 means can sample as many as possible).")
    parser.add_argument('-np1c', '--n-prompt-max-type1c', type=int, required=False, default=-1, help="Maximum different number of prompt type 3 to be sampled (-1 means can sample as many as possible).")
    parser.add_argument('-np2', '--n-prompt-max-type2', type=int, required=False, default=-1, help="Maximum different number of prompt type 4 to be sampled (-1 means can sample as many as possible).")
    parser.add_argument('--is-eval', default=True, action=argparse.BooleanOptionalAction, help="Whether train or evaluation.")
