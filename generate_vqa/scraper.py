...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input_path', type=str, required=False, default=os.path.join(RESOURCE_DIR, "food_df.csv"), help="Path used to load full dataframe")
    parser.add_argument('-o', '--output_path', type=str, required=False, default=os.path.join(RESOURCE_DIR, "food_df.csv"), help="Path used to load food dataframe")
