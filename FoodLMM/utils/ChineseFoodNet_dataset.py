...
class ChineseFoodNet(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        DATA_DIR = os.path.join(base_image_dir, "ChineseFoodNet")
        self.image_root = os.path.join(DATA_DIR, 'release_data')
        
        with open(os.path.join(DATA_DIR, 'train_title.json')) as f:
            data = json.load(f)
        self.data = data
