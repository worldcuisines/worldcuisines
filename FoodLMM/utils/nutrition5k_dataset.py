...
class Nutrition5kDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.overhead_images = os.listdir(os.path.join(self.DATA_DIR, 'realsense_overhead'))
        self.angle_images = os.listdir(os.path.join(self.DATA_DIR, 'images'))
        self.cafe_1_csv_path = os.path.join(self.DATA_DIR, 'metadata/dish_metadata_cafe1.csv')
        self.cafe_2_csv_path = os.path.join(self.DATA_DIR, 'metadata/dish_metadata_cafe2.csv')
        self.ft = ft
    ...
    def __getitem__(self, idx):
        ...
        # if item in self.overhead_images:
        csv_path = None
        ...
        with open(csv_path, 'r') as file:
            ...
            for row in reader:
                if row[0] == item:
                    ...
                    if self.ft:
                        question_idx = random.randint(3, 4)
                    if question_idx == 0:
