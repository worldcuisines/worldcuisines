...
dataset_1_large_df['pixtral_inferrence_1_openform'] = dataset_1_large_df.progress_apply(infer_with_error_handling_openform, axis=1)

dataset_1_large_df.to_csv(f"./inferred_task1_large_openform.csv", index=False)