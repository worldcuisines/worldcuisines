...
dataset_2_large_df['pixtral_inferrence_2_multichoice'] = dataset_2_large_df.progress_apply(infer_with_error_handling_multichoice, axis=1)

dataset_2_large_df.to_csv(f"./inferred_task2_large_multichoice.csv", index=False)